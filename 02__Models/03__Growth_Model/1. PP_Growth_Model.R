...
pp_model <- '
  # Latent Variables:
  LS_w1 =~ v1*LS1_w1 + v2*LS2_w1 + v3*LS3_w1 + LS4_w1 + LS5_w1;
  LS_w2 =~ v1*LS1_w2 + v2*LS2_w2 + v3*LS3_w2 + LS4_w2 + LS5_w2;
  ...
  # Direct Effect
  Procra ~ c*Age_w1 + b1*slope_ls + b2*slope_con + b3*slope_neu;
